...
public class DispatchRepository extends BaseRepository implements Repository<Dispatch> {
    ...
    private Dispatch mapDispatch(ResultSet resultSet) throws SQLException {
        ...
        request.setStatus(RequestStatus.valueOf(resultSet.getString("request_status")));
        ...
        dispatch.setDispatchDate(LocalDateTime.parse(resultSet.getString("dispatch_date")));
        dispatch.setStatus(DispatchStatus.valueOf(resultSet.getString("status")));
        return dispatch;
    }
}